...
public class Principal {
	...
	public static void main(String[] args) {
		 ...
		 * 
		 * int [][] costes = {{11, 12, 18, 40}, {14, 15, 13, 22}, {11, 17, 19, 23}, {17,
		 * 14, 20, 28}};
		 * 
		 * for (int i = 0; i < costes.length; i++) { for (int j = 0; j <
		 * costes[i].length; j++) { System.out.print(costes[i][j] + "\t"); }
		 * System.out.println(); }
		 */
		 ...
		 * 
		 * Agente a = new Agente(); int [] costesAgenteA = {11, 12, 18, 40};
		 * a.setTareasAgente(costesAgenteA);
		 * 
		 * Agente b = new Agente(); int [] costesAgenteB = {14, 15, 13, 22};
		 * b.setTareasAgente(costesAgenteB);
		 * 
		 * Agente c = new Agente(); int [] costesAgenteC = {11, 17, 19, 23};
		 * c.setTareasAgente(costesAgenteC);
		 * 
		 * Agente d = new Agente(); int [] costesAgenteD = {17, 14, 20, 28};
